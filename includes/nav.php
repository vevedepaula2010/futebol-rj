...
<nav class="navbar">
    <div class="container navbar-container">
        ...
        <ul class="nav-links navbar-menu">
            ...
            <li class="navbar-item"><a href="lesoes/listar.php" class="navbar-link">Lesões</a></li>
            <li class="navbar-item"><a href="performance/listar.php" class="navbar-link">Performance</a></li>
